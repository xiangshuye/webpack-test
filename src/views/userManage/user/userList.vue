    ...
    return {
      ...
      columns: Object.freeze([
        ...
        },
        {
          ...
          render: (h, params) => {
            return (
              <Button type="text" on-click={() => this.edit(params.row)}>
                编辑
              </Button>
            );
          }
        ...
        },
        {
          ...
          render: (h, params) => {
            return (
              <div class="action">
                <Button type="text" on-click={this.edit.bind(this, params.row)}>
                  编辑
                </Button>
                <Button type="text" onClick={() => this.resetPwd(params.row)}>
                  重置密码
                </Button>
                <Button
                  type="text"
                  onClick={() => this.changeStatus(params.row)}
                >
